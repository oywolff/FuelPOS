...
namespace TankForm.Logic
{
    internal class RoleActions
    {
        internal void AddUserAndRole()
        {
            ...
            // Create the "canPeile" role if it doesn't already exist.
            if (!roleMgr.RoleExists("canPeile"))
            {
                IdRoleResult = roleMgr.Create(new IdentityRole { Name = "canPeile" });
            }

            // Create the "canEdit" role if it doesn't already exist.
            if (!roleMgr.RoleExists("canRead"))
            {
                IdRoleResult = roleMgr.Create(new IdentityRole { Name = "canRead" });
            }
